 ...
 * @internal
 *
 * @covers \Flexic\DataProvider\International\LocaleProvider
 */
final class LocaleProviderTest extends AbstractTestCase
{
    public function testArbitrary(): void
    {
        $value = TestUtil::string(\Flexic\DataProvider\International\LocaleProvider::arbitrary());
