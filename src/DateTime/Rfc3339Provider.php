...
final class Rfc3339Provider extends AbstractDateProvider
{
    /**
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-very-near-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-near-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-very-far-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-very-near-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-near-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-far-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'rfc3339-very-far-history' === $key;
        });
    }
