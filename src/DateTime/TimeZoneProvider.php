...
final class TimeZoneProvider extends AbstractProvider
{
     ...
     * @return \Generator<string, array{0: string}>
     */
    public static function indian(): \Generator
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'timezone-indian' === $key;
        });
    }
     ...
     * @return \Generator<string, array{0: string}>
     */
    public static function utc(): \Generator
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'timezone-utc' === $key;
        });
    }
    ...
    public static function values(): array
    {
        ...
        return [
            'timezone-america' => $faker->randomElement([
                'America/Adak',
                'America/Anchorage',
                'America/Anguilla',
                'America/Antigua',
            ...
            'timezone-asia' => $faker->randomElement([
                'Asia/Aden',
                'Asia/Almaty',
                'Asia/Amman',
                'Asia/Anadyr',
            ...
            'timezone-australia' => $faker->randomElement([
                'Australia/Adelaide',
                'Australia/Brisbane',
            ...
            'timezone-africa' => $faker->randomElement([
                'Africa/Abidjan',
                'Africa/Accra',
                'Africa/Addis_Ababa',
                'Africa/Algiers',
            ...
            'timezone-indian' => $faker->randomElement([
                'Indian/Antananarivo',
                'Indian/Chagos',
                'Indian/Christmas',
                'Indian/Cocos',
            ...
            'timezone-pacific' => $faker->randomElement([
                'Pacific/Apia',
                'Pacific/Auckland',
            ...
            'timezone-antarctica' => $faker->randomElement([
                'Antarctica/Casey',
                'Antarctica/Davis',
            ...
            'timezone-arctic' => 'Arctic/Longyearbyen',
            'timezone-atlantic' => $faker->randomElement([
                'Atlantic/Azores',
                'Atlantic/Bermuda',
                'Atlantic/Canary',
                'Atlantic/Cape_Verde',
