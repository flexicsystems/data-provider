...
final class DateTimeProvider extends AbstractDateProvider
{
    /**
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-very-near-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-near-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-far-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-very-far-future' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-very-near-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-near-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-far-history' === $key;
        });
    }
    ...
    {
        yield from self::provideDataForValuesWhereKey(self::values(), static function (string $key): bool {
            return 'date-time-very-far-history' === $key;
        });
    }
    ...
    public static function values(): array
    {
        ...
        }, parent::generatedValues('date-time'));
    }
}
